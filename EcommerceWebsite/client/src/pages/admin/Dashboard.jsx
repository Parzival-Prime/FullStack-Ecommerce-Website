...
const colorScale = scaleQuantize()
  .domain([0, 100])
  .range(['#2d8a8f', '#7fc1b6', '#c6e7c2', '#f0f9e8']);
...
function Dashboard() {
  ...
  return (
    <div style={{ paddingTop: '6rem', minHeight: '140svh', maxHeight:'305svh', color: 'var(--greenCream)', backgroundColor: 'var(--oceanDark)', fontFamily: 'var(--sofiaSans)' }}>
